...
<header class="px-10">
    <form action="" method="post" class="flex items-center justify-between">
        ...
        <div class="flex gap-4">
            ...
            <label class="relative flex items-center gap-2 px-5 rounded-full input border-[#6D7A75] h-14"><span class="absolute px-4 text-sm bg-white bottom-12">Tanggal Publikasi</span>
                <input type="date" class="grow" placeholder="-- Semua --" />
            </label>
        </div>
        <div>
            <button type="submit" class="btn w-full justify-normal rounded-full bg-[#005B4D] font-normal text-white">
                <div>
    ...
    <article class="flex flex-col gap-10 bg-[#F0F5F1] p-5 rounded-2xl">
        ...
        <form action="" method="post" class="flex flex-col gap-10">
            ...
            <label class="relative flex items-center gap-2 px-5 rounded-2xl input border-[#6D7A75] bg-transparent h-32"><span class="absolute px-4 text-sm bg-[#F0F5F1] bottom-[7.5rem]">Keterangan</span>
                <textarea class="bg-transparent grow"></textarea>
            </label>
