...
<article class="grid grid-flow-row-dense grid-cols-4 grid-rows-1 gap-10">
    <section class="col-span-3">
        <article>
            <header>
                <h1>Informasi Keuangan</h1>
                <p><b>TK / TKIT Muslimat NU Babalanlor</b><br>Tahun Ajaran 2024/2025</p>
            </header>
            <div class="collapse collapse-arrow text-[#005B4D]">
                ...
                <div class="collapse-title text-xl font-medium">Uang Pangkal</div>
            ...
            <div class="collapse collapse-arrow text-[#005B4D]">
                ...
                <div class="collapse-title text-xl font-medium">SPP</div>
                <div class="collapse-content bg-[#F0F5F1]">
    ...
    <section class="flex flex-col gap-4">
        ...
        <article class="flex flex-col gap-5 border-solid border-2 border-[#BCC9C4] rounded-xl p-4">
            ...
            <article>
                <header>
                    <h1 class="font-bold">Tagihan SPP Anak</h1>
                    <p>SPP - T.A 2024/2025 Genap</p>
                </header>
                <p>Segera lakukan pembayaran SPP peride akademik 2024/2025 dan lakukan konfirmasi apabila telah dilakukan.</p>
            </article>
        </article>
        <article class="flex flex-col gap-5 border-solid border-2 border-[#BCC9C4] rounded-xl p-4">
            <header class="flex justify-between">
        ...
        <article>
            ...
            <article class="carousel rounded-box mt-5">
